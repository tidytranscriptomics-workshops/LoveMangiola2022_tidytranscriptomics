...
-   Open `tidytranscriptomics_case_study.Rmd` in `LoveMangiola2022_tidytranscriptomcs/vignettes` folder
...
seurat_obj |>
  ...
  mutate(gate = tidygate::gate_int(UMAP_1, UMAP_2, gate_list = LoveMangiola2022tidytranscriptomics::gate_seurat_obj)) |> 
